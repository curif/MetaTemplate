// Some minor adjustment to the excelent shader of @luka712
...
Shader "Hidden/CrtPostProcess"
{
	Properties
	{
		...
		u_scanline_size_2("scanline_size_2", Float) = 20
		u_scanline_speed_2("scanline_speed_2", Float) = 3
		u_scanline_amount("scanline_amount", Float) = 0.05
		u_vignette_size("vignette_size", Float) = 1.9
		u_vignette_smoothness("vignette_smoothness", Float) = 0.6
		u_vignette_edge_round("vignette_edge_round", Float) = 8
		u_noise_size("noise_size", Float) = 75
		u_noise_amount("noise_amount", Float) = 0.05
		u_redOffset_x("redOffset_x", Float) = 0
		u_redOffset_y("redOffset_y", Float) = -0.01
		u_blueOffset_x("blueOffset_x", Float) = 0
		u_blueOffset_y("blueOffset_y", Float) = 0
		u_greenOffset_x("greenOffset_x", Float) = 0
		u_greenOffset_y("greenOffset_y", Float) = 0.01
	}
